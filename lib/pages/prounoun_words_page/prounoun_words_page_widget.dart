...
class _ProunounWordsPageWidgetState extends State<ProunounWordsPageWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PronounsRecord>>(
      stream: queryPronounsRecord(
        queryBuilder: (pronounsRecord) => pronounsRecord.orderBy('signName'),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<PronounsRecord> prounounWordsPagePronounsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final prounounWordsPagePronounsRecord =
            prounounWordsPagePronounsRecordList.isNotEmpty
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              prounounWordsPagePronounsRecord!
                                                  .signImage,
                                              width: 300.0,
                                              height: 200.0,
                                              fit: BoxFit.cover,
