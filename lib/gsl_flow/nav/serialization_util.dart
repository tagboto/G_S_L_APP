...
import '../../gsl_flow/place.dart';
import '../../gsl_flow/uploaded_file.dart';
...
String placeToString(GSLPlace place) => jsonEncode({
...
String uploadedFileToString(GSLUploadedFile uploadedFile) =>
...
String? serializeParam(
  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.GSLPlace:
        return placeToString(param as GSLPlace);
      case ParamType.GSLUploadedFile:
        return uploadedFileToString(param as GSLUploadedFile);
      case ParamType.JSON:
...
GSLPlace placeFromString(String placeStr) {
...
GSLUploadedFile uploadedFileFromString(String uploadedFileStr) =>
    GSLUploadedFile.deserialize(uploadedFileStr);
