...
class GSLParameters {
  GSLParameters(this.state, [this.asyncParams = const {}]);
...
class GSLRoute {
  ...
  final Map<String, Future<dynamic> Function(String)> asyncParams;
  final Widget Function(BuildContext, GSLParameters) builder;
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          final GSLParams = GSLParameters(state, asyncParams);
          final page = GSLParams.hasFutures
              ? FutureBuilder(
                  future: GSLParams.completeFutures(),
                  builder: (context, _) => builder(context, GSLParams),
                )
              : builder(context, GSLParams);
