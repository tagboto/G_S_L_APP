...
class GSLUploadedFile {
  const GSLUploadedFile({
    this.name,
    this.bytes,
    this.height,
    this.width,
  ...
  @override
  String toString() =>
      'GSLUploadedFile(name: $name, bytes: ${bytes?.length ?? 0}, height: $height, width: $width, blurHash: $blurHash,)';
  ...
  static GSLUploadedFile deserialize(String val) {
